    ...
    if ( !is_front_page() ) {
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            if(!empty($last_category)) {
                echo $cat_display;
                echo '<li class="active item-current item-' . $post->ID . '">' . get_the_title() . '</li>';
            ...
            // Category page
            echo '<li class="active item-current item-cat">' . single_cat_title('', false) . '</li>';
            ...
            // Day display
            echo '<li class="active item-current item-' . get_the_time('j') . '">' . get_the_time('jS') . ' ' . get_the_time('M') . ' Archives</li>';
            ...
            echo '<li class="active item-current item-current-' . get_the_time('Y') . '">' . get_the_time('Y') . ' Archives</li>';
            ...
            // Paginated archives
            echo '<li class="active item-current item-current-' . get_query_var('paged') . '">'.__('Page') . ' ' . get_query_var('paged') . '</li>';

        } else if ( is_search() ) {

            // Search results page
            echo '<li class="active item-current item-current-' . get_search_query() . '">Search results for: ' . get_search_query() . '</li>';
